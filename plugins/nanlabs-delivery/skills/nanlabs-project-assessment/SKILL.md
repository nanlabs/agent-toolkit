---
name: nanlabs-project-assessment
description: >-
  WHAT - Interactive project assessment router: define scope and units, collect evidence
  via nanlabs-project-assessment-evidence, then delegate to technical or management unit
  assessment skills. Always evidence-based and human-reviewed.
---
...
1. Apply **`nanlabs-output-handshake`** before producing any final assessment report, scorecard, action plan, or executive summary: ask where the artifact should live and confirm human review.
2. Apply **`nanlabs-project-assessment-evidence`** before scoring. Evidence may live in repositories, boards, docs, spreadsheets, dashboards, incidents, PRs, meetings, interviews, Slack, emails, or any other project system. Ask the user where to find each source.
...
2. **Evidence collection**
   - Delegate to **`nanlabs-project-assessment-evidence`**.
...
3. **Unit assessment**
   - For technical workloads, delegate to **`nanlabs-technical-unit-assessment`**.
   - For project management and delivery scopes, delegate to **`nanlabs-management-unit-assessment`**.
   - If UI depth is required, pair the technical unit assessment with **`ui-ux-pro-max`**.
   - If repository discovery is required, pair with **`nanlabs-assistant`** and the repository-specific rules.
...
- `nanlabs-technical-unit-assessment` - technical unit indicators and template
- `nanlabs-management-unit-assessment` - management unit indicators and template
- `nanlabs-output-handshake` - destination and human review

---
name: nanlabs-project-assessment-evidence
description: >-
...
5. Do not score indicators. Return the evidence map to **`nanlabs-project-assessment`**, **`nanlabs-technical-unit-assessment`**, or **`nanlabs-management-unit-assessment`**.
...
- `references/example-evidence-map.md` — example evidence map for a platform assessment
- `nanlabs-project-assessment` - assessment router
- `nanlabs-technical-unit-assessment` - technical scoring
- `nanlabs-management-unit-assessment` - management scoring
- `nanlabs-output-handshake` - destination and review for final artifacts

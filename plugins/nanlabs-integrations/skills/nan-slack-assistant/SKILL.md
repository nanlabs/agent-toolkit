---
name: nan-slack-assistant
description: Read channels/messages, send messages, add reactions, and browse canvases in Slack workspaces. Use for NaNLABS Slack channels, messages, or notifications — NOT for Slack app development (use slack-cli).
metadata:
  author: nanlabs
  version: "1.0"
...
# NaNLABS Slack Assistant (`slackcli`)
...
| Context | Workspace |
|---|---|
| NaNLABS | `nan-labs` (nan-labs.slack.com) |
...
- Workspace is nan-labs.slack.com (or whichever workspace the user indicates)
...
slackcli conversations list --workspace=nan-labs
...
```bash
# Use NaNLABS workspace explicitly
slackcli conversations list --workspace=nan-labs
...
1. Find the channel ID: `slackcli conversations list --workspace=nan-labs | grep <name>`

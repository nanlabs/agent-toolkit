...
Agent index: `agent-toolkit /agents/agent-catalog.yaml`. Orchestration detail: **nanlabs-assistant** skill `${CLAUDE_PLUGIN_ROOT}/resources/agents/nanlabs-assistant/ORCHESTRATION.md`.

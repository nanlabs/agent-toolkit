...
## D — Technical GitHub Copilot

- [ ] Validate Agent Plugins v1.0.0 manifests
- [ ] Verify repository customization under `.github/`
- [ ] Record Copilot results in current release evidence ([RELEASE.md](RELEASE.md))

## E — Claude (non–Claude Code) / skills path

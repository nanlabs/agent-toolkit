...
def wiki_plugin_marketplace(
    ...
    return (
        ...
        "\n"
        "> [!TIP]\n"
        "> New here? Start at [Installation](Installation), then come back for the "
        "complete copy-paste blocks. Day-to-day use: [Using the toolkit](Using).\n"
        "\n"
...
def wiki_skills_reference(layout_groups: dict[str, list[str]]) -> str:
    ...
    return (
        ...
        "\n"
        "> [!TIP]\n"
        "> To **add** a skill, follow [Add a skill](Add-a-Skill). To **install** one, "
        "use the matching group plugin or `npx skills` below.\n"
        "\n"
...
def wiki_mcp_setup(mcp_catalog: dict[str, dict[str, Any]]) -> str:
    return (
        ...
        "\n"
        "> [!TIP]\n"
        "> Install the plugin, reload, then complete OAuth in the client. "
        "Walkthrough: [Installation](Installation) → [Using the toolkit](Using).\n"
        "\n"

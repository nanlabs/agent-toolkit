---
name: nanlabs-incident
description: >-
  WHAT - Draft and review incident reports and RCA notes using NaNLABS Incident Management guidance; includes detection, impact, timeline, RCA, resolution, and follow-ups.
---
...
3. Use **`nanlabs-meeting-minutes`** if a validation or post-incident meeting needs minutes.

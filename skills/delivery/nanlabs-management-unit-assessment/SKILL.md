---
name: nanlabs-management-unit-assessment
description: >-
...
- `nanlabs-planning` - planning and estimation evidence
- `nanlabs-development-workflow` - workflow, DoR, DoD, and validation evidence
- `nanlabs-meeting-minutes`, `nanlabs-decision-log`, `nanlabs-agreement`, `nanlabs-incident` - common management evidence artifacts

...
name: nanlabs-epic
description: >-
  WHAT - Draft and review epics using the NaNLABS Best Practices Epic Template; includes objectives, success criteria, related tasks, stakeholders, and effort metadata.
---
...
2. Use **`nanlabs-planning`** for estimation and breakdown.

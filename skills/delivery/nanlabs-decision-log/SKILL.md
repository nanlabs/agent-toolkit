...
- Use **`nanlabs-decision-log`** for lightweight operational, product, or project decisions.
- Use **`nanlabs-agreement`** for explicit commitments or terms among parties.
- Use **`nanlabs-adr`** for durable architecture or technical decisions.

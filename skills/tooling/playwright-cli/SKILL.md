---
name: playwright-cli
description: Drive a real browser from the terminal with the Playwright CLI (snapshot, click, fill, screenshots, traces) for CLI-first automation — data extraction, UI debugging, form fills, multi-tab work. For Playwright **test specs**, use `nanlabs-e2e-runner` instead.
---

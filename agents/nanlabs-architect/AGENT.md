...
- `references/CONTRACT.md` — read before proceeding (methodology, anti-patterns, output contract)
- `references/PATTERNS.md` — SOLID, Clean Architecture, patterns catalog

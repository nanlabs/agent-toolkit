...
Use this as a **project-local** supplement. The **nanlabs-assistant** skill explains how agents should discover README, docs, and this file; do not duplicate long prose from those sources here—link or point to them instead.
